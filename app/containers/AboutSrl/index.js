...
export default class AboutSrl extends React.PureComponent {
  render() {
    ...
    return (
      ...
      <h2>Our Goals</h2>
      <p>1. Teach students about robots and programming.<br/>
      2. To give marginalized students the same recognition for efforts in technology as that given to students in athletics.<br/>
      3. Provide tools, educational opportunities for science and math teachers to incorporate this curriculum into their STEM standards and Career Pathway standards.</p>
      </div>
